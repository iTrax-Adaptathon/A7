...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Workout History & Logs')),
      body: SafeArea(
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Complete your first workout to view historical adaptive logs.',
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${ex.sets.length} Sets • ${ex.sets.first.actualWeight} kg',
                        ),
                      ],
                    ),
                  ),
